...
// (small chunks, for instant playback + seeking), and handling those
// correctly through the Cache API turned out to cause real playback
// problems (buffering/looping) in practice. Letting audio requests go
// straight to the network (normal browser behavior) is what keeps
// streaming reliable. Songs are not available offline — only the app
// itself (player UI) works offline, not the music.
